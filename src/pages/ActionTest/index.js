...
import Edit, { UpdateDetail, GetKeyDetail } from './edit';
...
export default class Index extends React.PureComponent {
  ...
  render() {
    const { error, loading, cacheCount, _updateCache, _clearCache,
      _getKeyValue, _updateDetail, pattern, pargraphList: enums, keyValue,
      ...
      <div className={style.Action}>
        <div className="action-block">
          ...
          <div className="block">
            <h3>更新详情缓存</h3>
            <div>
              <UpdateDetail handle={_updateDetail} loading={loading.updateDetail} dynamicParams={{ choose: enums }} />
            </div>
          </div>
          <div className="block">
            <h3>获取缓存值</h3>
            <div>
              <GetKeyDetail handle={_getKeyValue} loading={loading.getKeyValue} dynamicParams={{ chose: enums }} />
            </div>
          </div>
          <div className="block">
            <Edit handle={_upload} />
